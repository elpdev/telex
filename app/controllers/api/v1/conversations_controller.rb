class API::V1::ConversationsController < API::V1::BaseController
  before_action :set_conversation, only: [:show, :timeline]
  ...
  def index
    ...
    render_data(records.map { |conversation| API::V1::Serializers.conversation(conversation) }, meta: meta)
  end

  def show
    render_data(API::V1::Serializers.conversation(@conversation))
  end
